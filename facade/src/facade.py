...
class Equalizer:
    ...
    def set_mode(self, mode: str) -> None:
        self.mode = mode
        print(f"Ecualizador ajustado al modo: {mode}")
...
class MediaPlayerFacade:
    def __init__(self):
        ...
        self.equalizer = Equalizer()  # Nuevo subsistema
    ...
    def play_media(self, file: str) -> None:
        ...
        if file_type == "audio":
            ...
            print(f"Modo de ecualizador actual: {self.equalizer.get_mode()}")
    ...
    # NUEVO método para el ecualizador
    def set_equalizer_mode(self, mode: str) -> None:
...
def main():
    ...
    # Configurar modo de ecualizador antes de reproducir
    media_player.set_equalizer_mode("Rock")
    ...
    # Cambiar el modo de ecualizador durante la ejecución
    media_player.set_equalizer_mode("Pop")
    media_player.play_next()
